...
const int TEMP_THRESHOLD_LOWER = 30; // lower threshold of temperature, change to your desire value
...
void loop() 
{
  ...
  if (command.length() > 0) 
  {
    ...
    else if(command == "lamp on") //this command will be given as an input to switch off light1 simillarly other commands work
    {
      while(true)
      {
        ...
        delay(500);
        /*if(command == "lamp off") //this command will be given as an input to switch off light1 simillarly other commands work
        {
          break;
        }*/
